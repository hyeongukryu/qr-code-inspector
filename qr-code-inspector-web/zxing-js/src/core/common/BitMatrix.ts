...
export default class BitMatrix /*implements Cloneable*/ {
    ...
    private luminances: Float64Array;
    ...
    public constructor(private width: number /*int*/, private height?: number /*int*/,
        ...
        this.luminances = new Float64Array(this.width * this.height);
    }
    ...
    public setLuminance(x: number, y: number, value: number) {
        this.luminances[y * this.width + x] = value;
    }

    public getLuminance(x: number, y: number): number {
        return this.luminances[y * this.width + x];
    }
