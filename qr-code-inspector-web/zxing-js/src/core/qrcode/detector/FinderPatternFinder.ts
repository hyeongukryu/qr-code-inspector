...
export default class FinderPatternFinder {
    ...
    public find(hints: Map<DecodeHintType, any> | null | undefined): FinderPatternInfo /*throws NotFoundException */ {
    ...
    private findRowSkip(): number /*int*/ {
        ...
        let firstConfirmedCenter: ResultPoint | null = null;
    ...
    private selectBestPatterns(): FinderPattern[] /*throws NotFoundException */ {
        ...
        (window as any).finderPatternCount = startSize;
